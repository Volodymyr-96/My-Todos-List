...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (4, 'Mike', 'Brown', 'mike@mail.com', '$2a$10$CdEJ2PKXgUCIwU4pDQWICuiPjxb1lysoX7jrN.Y4MTMoY9pjfPALO', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (3, 'Admin', '#1', 'admin@mail.com', '$2y$10$chzzf14fQo.czMtDcHsvmORML0m1OrluBkzvZR3F7UxfEawHsu87S', 1);
